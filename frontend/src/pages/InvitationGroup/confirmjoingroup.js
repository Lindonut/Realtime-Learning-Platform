...
function ConfirmJoinGroup() {
    ...
    const handleJoin = async() => {
        try {
            const res = await axios.post(`${process.env.REACT_APP_API_URL}/group/${groupID}/joingroup/${token}`)
    ...
    return (
        <div className='container'>
            <h1>Comfirm Join Group</h1>
            <p className='center'>You are joining this group as member role. Please confirm again.</p>
